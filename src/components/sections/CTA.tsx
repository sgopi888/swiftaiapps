      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          <h2 className="text-[clamp(28px,5vw,48px)] font-extrabold tracking-tight mb-4">
            Ready to Deploy AI
            <br className="hidden sm:block" /> That Works?
          </h2>
          <p className="text-[#c2c6d6] text-base leading-relaxed mb-10 max-w-lg mx-auto">
            Share your requirements and we&rsquo;ll map out the right AI system for your
            business — or book a free 30-minute discovery call.
          </p>
